...
DECLARE_COMPONENT_VERSION("KWSX Integration","0.0.1","A foobar2000 plugin for liking KWSX tracks and viewing artwork.");


// This will prevent users from renaming your component around (important for proper troubleshooter behaviors) or loading multiple instances of it.
VALIDATE_COMPONENT_FILENAME("foo_kwsx.dll");
